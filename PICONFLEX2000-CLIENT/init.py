...
if setting.rezalOn:  # Si la box à ping l'addresse IP déclarée du serveur:
    ...
    MENU_getCode(config.codeOffline,
                 "Code Offline")  # Demande du code Offline pour permettre à la box d'effectuer des actions sans le serveur (Les requêtes de modification de la BDD seront sauvegardées et synchroniser à la prochaine connection)
